...
public class MediaRecorder2 extends MediaRecorder {

    private final static String TAG = "MediaRecorder2";
    private static final boolean VERBOSE = false;

    private io.flutter.plugins.camera.media.custom.VideoEncoder mVideoEncoder;
    private io.flutter.plugins.camera.media.custom.AudioEncoder mAudioEncoder;
    ...
    public MediaRecorder2() {
        mVideoEncoder = new io.flutter.plugins.camera.media.custom.VideoEncoder();
        mAudioEncoder = new io.flutter.plugins.camera.media.custom.AudioEncoder();
    }
    ...
    @RequiresApi(api = Build.VERSION_CODES.S)
    public MediaRecorder2(@NonNull Context context) {
        throw new NotImplementedError();
    }
